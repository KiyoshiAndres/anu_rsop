...
\begin{document}
	...
	We want to study homotopy-invariant constructions that are preserved by suspension. We want to construct a "stable homotopy category" where this stable behavior can be studied.
	
	\subsection*{What is Stable Phenomena?}
	
	We want to work with closed monoidal categories for our constructions.
	
	\begin{definition}
		The category of topological spaces $\textrm{Top}$. is defined to be the category of compactly generated weak Hausdorff topological spaces with continuous maps for morphisms $\textrm{Top}(A,B)$. 
	\end{definition}
